<template>
  <div class="header-container">
    <nav class="flex w-full px-2">
      <router-link class="flex text-xl" to="/">
        <svg
      ...
      <div
        v-if="$store.getters._isAuthenticated"
      ...
      >
        ...
        <div class="relative group">
          ...
          >
            <router-link to="/settings" class="mb-2 menu-item">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                height="24"
            ...
            <router-link to="/favorites" class="mb-2 menu-item">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                class="fill-current mr-1"
                height="24"
            ...
            >
            <router-link to="/likes" class="mb-2 menu-item">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                class="fill-current mr-1"
                height="24"
